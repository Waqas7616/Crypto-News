    ...
    return (
        <div className='mt-3'>
            <div className="info flex items-center justify-between">
                ...
                <h6 className="text-blackColor text-[12px] font-[500] dark:text-white">Artyom Khomenko</h6>
                <p className="text-lightBlack text-[10px] dark:text-white">@artyom_khomenko.</p>
            ...
            <h6 className="text-blackColor mt-3 text-[14px] font-[400] dark:text-white">Spread the world this is going to catch on very bullish spread the word this is going </h6>
            ...
            <div className="view-count flex items-center justify-between mt-3">
                ...
                <p className="flex items-center gap-1 text-[10px] text-lightBlack dark:text-white">
                    ...
                    21
                </p><button className='dark:text-white'>...</button>
            </div>
