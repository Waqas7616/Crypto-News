...
function MobileMenu({ isNightMode, toggleMode }) {
  ...
  return (
    <div className="mob-nav relative block md:hidden">
      ...
      <div className="w-11/12 m-auto my-3">
        <Button text="Gaming" />
      </div>

      <div className="bg-[#EEEEEE] dark:bg-[#212121] w-11/12 m-auto p-2 rounded-sm">
        <span className=" text-[8px]  m-auto flex items-center flex-wrap gap-[3px] text-lightBlack dark:text-white ">
          Sponsored:{" "}
          <span>
            <svg
              width="15"
        ...
        <div className="w-[100vw] h-[100vh] absolute top-0 left-0 bg-white dark:bg-black ">
          <div className="flex flex-col gap-3 w-10/12 relative">
            ...
            <button
              ...
              className="absolute top-3 right-2 dark:text-white"
            >
              close
            </button>
          </div>
