  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        ...
        <button className="bg-[#EEEEEE] dark:bg-[#212121] dark:text-white border-2 rounded-md border-[#DDDDDD] px-2 py-1 flex items-center gap-2">
      ...
      <h1 className="font-medium text-[1rem] md:text-[2rem]  text-blackColor dark:text-blue mt-1">
        Daily Active Bitcoin Addresses Hit Yearly Peak, Cross 1M as BTC
      </h1>
      <p className="desc font-[500] text-[12px] md:text-[16px] text-blackColor my-3 dark:text-white">
      ...
      <div className="blogAuthor flex items-center justify-between mb-3 pr-3">
        <p className="text-lightBlack text-[9px] md:text-[14px] font-[500]">
          By{" "}
          <span className="text-blue text-[9px] md:text-[14px]">
            Sam Wisdom Raphel
          </span>
        </p>
        <p className="text-lightBlack font-[400] text-[9px] md:text-[12px] dark:text-white">
      ...
      <div className="nextBlog mt-3">
        <h4 className="text-red text-[12px] md:text-[14px]">Defi</h4>
        <h1 className="text-blackColor font-[500] dark:text-white text-[10px] md:text-[18px]">
        ...
        <div className="blogAuthor flex items-center justify-between pr-3">
          <p className="text-lightBlack text-[9px] md:text-[14px] font-[500] dark:text-white">
            By{" "}
            <span className="text-red text-[9px] md:text-[14px]">
              Sam Wisdom Raphel
            </span>
          </p>
          <p className="text-lightBlack font-[400] text-[9px] md:text-[12px] dark:text-white">
