...
function BlogCard() {
    return (
        <div>
            ...
            <p className='text-lightBlack font-[400] text-[16px] dark:text-white'>People talk about</p>
            ...
            <div className="blogAuthor flex items-center justify-between mb-3 pr-3">
                ...
                <p className="text-lightBlack font-[400] text-[12px] dark:text-white">Jan 26,2024 at 6:06 am</p>
                <p className="text-lightBlack font-[400] text-[12px] dark:text-white">24.1k views / 8.9k likes</p>
            </div>

            <div className="nextBlog mt-3">
                <h4 className="text-red">Defi</h4>
                <h1 className="text-blackColor dark:text-white">ethererum DeFI Gets “Gasiess’ Trading with New Ox API Address</h1>
                <div className="blogAuthor flex items-center justify-between pr-3">
                    <p className="text-lightBlack text-[14px] font-[500] dark:text-white">By <span className="text-red text-[14px]">Sam Wisdom Raphel</span></p>
                    <p className="text-lightBlack font-[400] text-[12px] dark:text-white">Jan 26,2024 at 6:06 am</p>
                    <p className="text-lightBlack font-[400] text-[12px] dark:text-white">24.1k views / 8.9k likes</p>
                </div>
                <hr className='my-3' />
