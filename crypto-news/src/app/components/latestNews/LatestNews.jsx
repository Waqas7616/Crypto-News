...
function LatestNews() {
        ...
        <div>
            ...
            <div class="flex ">
                ...
                <div class="grow pt-0.5 pb-8">
                    ...
                    <h2 class="mt-1 font-[500] text-blackColor dark:text-white">
    ...
    return (
        ...
        <div className="latestNews relative  h-[90vh] overflow-auto">
            <h2 className='text-blackColor text-[24px] font-[500] dark:text-blue'>Latest News</h2>
            <p className='text-lightBlack font-[400] text-[16px] dark:text-white'>Hot feeds everyday</p>
            {repeatedNews}
        </div>
