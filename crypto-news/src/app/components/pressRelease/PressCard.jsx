    ...
    <div className="">
      <div className="flex gap-2 w-[400px] h-[150px] items-center">
        ...
        <div className="coin-detail flex flex-col gap-1 flex-1">
          ...
          <h6 className="text-blackColor text-[16px] md:text-[18px] font-[500] dark:text-white">
            AOFverse Secure $3 Million in Private Funding Round Led by
            Animoca...
          </h6>
          <div className="flex justify-between items-center">
            <p className="text-lightBlack text-[9px] md:text-[12px] dark:text-[rgba(255,255,255,0.8)]">
              Aug 23, 2024
            </p>
            <p className="text-lightBlack text-[9px] md:text-[12px] dark:text-[rgba(255,255,255,0.8)]">
              374 views / 0 likes
