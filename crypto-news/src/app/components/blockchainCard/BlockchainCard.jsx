    ...
    <div>
      <div className="flex flex-col md:flex-row gap-3 mt-5">
        ...
        <div className="text-section pr-4 flex-1">
          <p className="text-red text-[12px] desc">Press Release</p>
          <h6 className="text-blackColor text-[12px] xl:text-[14px]  title dark:text-white 2xl:mt-3 3xl:mt-8">
            AOFverse Secure $3 Million in Private Funding Round Led by
            Animoca...
          </h6>
          <p className="text-lightBlack text-[12px] lg:text-[12px]  xl:text-[14px]  desc dark:text-[rgba(255,255,255,0.8)] 2xl:mt-3 3xl:mt-8">
          ...
          <div className="hidden md:flex items-center justify-between mt-1 2xl:mt-4 3xl:mt-12 flex-wrap">
            <div className="profile flex gap-1  items-center mb-3">
              ...
              <div className="profile-info ">
                <p className="text-blackColor  text-[10px] lg:text-[8px]  dark:text-white title">
                  Sara Ali
                </p>
                <p className="text-lightBlack text-[10px] lg:text-[8px]  dark:text-[rgba(255,255,255,0.8)] desc">
            ...
            <div className="view-info flex justify-between gap-2">
              ...
              <p className="flex items-center gap-1 desc text-lightBlack text-[10px]  dark:text-[rgba(255,255,255,0.8)]">
                <svg
                  width="15"
                  height="15"
                  viewBox="0 0 18 18"
              ...
              <p className="flex items-center desc gap-1 text-lightBlack text-[10px]  dark:text-[rgba(255,255,255,0.8)]">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
          ...
          <div className="flex items-center justify-between md:hidden  mt-1 2xl:mt-4 3xl:mt-12 ">
            <div className="profile flex items-center ">
              ...
              <div className="profile-info ">
                <p className="text-blackColor  text-[9px] lg:text-[8px]  dark:text-white title">
                  Sara Ali
                </p>
                <p className="text-lightBlack text-[9px] lg:text-[8px]  dark:text-[rgba(255,255,255,0.8)] desc">
                  Jan 27,2020 at 6:00am
                </p>
              </div>
            </div>
            <div className="flex flex-col">
              <div className="view-info flex justify-between gap-1">
                <p className="flex items-center gap-1 text-lightBlack text-[10px]  desc dark:text-[rgba(255,255,255,0.8)]">
                  <svg
                    width="12"
                    height="12"
                    viewBox="0 0 18 18"
              ...
              <div className="social-icons flex items-center ml-auto gap-2">
                {/* FB  */}
                <svg
                  width="12"
                  height="12"
