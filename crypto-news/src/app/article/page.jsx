      ...
      <div className="w-11/12 flex gap-3 mt-5 m-auto">
        ...
        <div className=" w-[55%] pr-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <div className="profile flex gap-1">
              ...
              <div className="profile-info">
                <p className="text-blackColor font-[500] text-[10px]">
                  Sara Ali
                </p>
                <p className="text-lightBlack text-[10px]">
          ...
          <p className="desc mt-4 text-lightBlack text-[14px]">
            ...
            hazards beyond those posed by traditional solid mineral extraction,
            such as gold mining. Here's why:
          </p>
          <h6 className="text-blackColor font-[500] text-[15px] mt-4">
            Scale and Visibility:
          </h6>
          <p className="mt-3 text-lightBlack text-[14px]">
            Bitcoin mining's environmental impact often garners attention due to
            its visibility in the digital asset space. However, the scale of
            gold mining operations globally is vast, often involving massive
            open-pit mines and extensive chemical processing. While Bitcoin
            mining's energy consumption is notable, the widespread and visible
            effects of gold mining on landscapes and ecosystems cannot be
            underestimated compared to Bitcoin’s.
          </p>
          <h6 className="text-blackColor font-[500] text-[15px] mt-4">
            Historical Context:
          </h6>
          <p className="mt-3 text-lightBlack text-[14px]">
            ...
            industry, and its environmental challenges are still evolving. While
            it's crucial to address the environmental impact of Bitcoin mining,
            it's equally important to contextualize it within the broader
            history and scale of resource extraction.
          </p>
          <h6 className="text-blackColor font-[500] text-[15px] mt-4">
          ...
          <p className="mt-3 text-lightBlack text-[14px]">
            ...
            and mitigation strategies to reduce their environmental footprints.
            From the adoption of renewable energy sources in Bitcoin mining
            operations to the development of more sustainable mining practices
            in the gold industry, efforts are underway to address environmental
            concerns across both sectors. As technology advances, opportunities
            for reducing environmental impact will continue to emerge in both
            industries. While scrutiny of Bitcoin mining's environmental impact
            is warranted, it should not be exaggerated beyond that of solid
            minerals such as gold. Both industries pose environmental challenges
            that require attention and action. By fostering equitable scrutiny
            and promoting sustainability across all resource extraction sectors,
            we can work towards a more balanced and responsible approach to
          ...
          <div className="reaction-buttons flex gap-5 mt-4 items-center">
            <button className="relative">
              <div className="absolute rounded-full text-[10px] w-[20px] h-[20px] flex justify-center items-center bg-blue text-white top-[-5px] right-0">
                56
              </div>
              <svg
                width="50"
          ...
          <div className="form mt-8">
            <div className="inputFields gap-5 flex items-center">
              <input
                className="flex-1 outline-none border-[#dddddd] text-lightBlack border-[1px] py-3 px-4 rounded-[8px]"
                type="text"
                placeholder="Name"
              />
              <input
        ...
        <div className=" w-[25%]">
          ...
          <h2 className="text-blackColor mt-8 font-[500] text-[20px]">
            Related Posts
          </h2>
          <div className="post-card mt-3">
            ...
            <h4 className="mt-4 text-blackColor font-[500] text-[14px]">
              From Shiba Inu to BabyDoge, Top 5 Altcoins Under $0.0001 to Watch
            </h4>
            <p className="mt-1 text-lightBlack text-[12px] font-semibold">
              Aug 23, 2023
            </p>
          </div>
          <div className="post-card mt-3">
