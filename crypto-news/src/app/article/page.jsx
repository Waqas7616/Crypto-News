...
import akion from "@/app/images/Akoin.png";
...
function Article() {
  ...
  return (
    <div>
      <div>
        <div className="w-11/12 3xl:w-[30%] flex flex-col md:flex-row items-start gap-3 mt-12 m-auto">
          <div className=" w-[20%] hidden md:block">
            <button className="bg-transparent w-[83%]  text-blue px-3 py-1 border-blue border-[2px] rounded-md flex items-center justify-center gap-3 md:text-[8px] lg:text-[11px] xl:text-[16px]">
              <svg
                className="md:w-[8px] lg:w-[11px] xl:w-[16px]"
                width="15"
                height="13"
                viewBox="0 0 15 13"
                fill="none"
            ...
            <div className="article-card mt-4 flex flex-col gap-2">
              <Image src={binance} alt="article" className=" w-[83%]" />
              <h4 className="article-title text-blackColor title w-[90%] text-[15px] dark:text-white">
                AOFverse Secure $3 Million in Private Funding
              </h4>
              <p className="date text-lightBlack text-[12px] dark:text-[rgba(255,255,255,0.8)]">
                Aug 23, 2023
              </p>
            </div>
            <button className="bg-transparent mt-3 w-[83%]  text-blue px-3 py-1 border-blue border-[2px] rounded-md flex items-center justify-center gap-3 md:text-[8px] lg:text-[11px] xl:text-[16px]">
              Next Post{" "}
              <svg
                className="md:w-[8px] lg:w-[11px] xl:w-[16px]"
                width="14"
          ...
          <div className=" w-[100%] md:w-[55%] pr-[0] md:pr-[16px]">
            <h2 className="text-blackColor title text-[18px] md:text-[20px] dark:text-white ">
              Daily Active Bitcoin Addresses Hit Yearly Peak, Cross 1M as BTC
            </h2>
            <p className="text-lightBlack mt-2 text-[12px] md:text-[14px] desc dark:text-[rgba(255,255,255,0.8)]">
              Daily active addresses on the Bitcoin network have recently hit a
              new yearly peak above the 1 million mark
            </p>
            <div className="flex items-center justify-between  mt-2">
              <div className="profile flex items-center gap-1 ">
                ...
                <div className="profile-info">
                  <p className="text-blackColor font-[500] text-[10px] dark:text-white">
                    Sara Ali
                  </p>
                  <p className="text-lightBlack text-[10px] dark:text-[rgba(255,255,255,0.8)]">
                    Jan 27,2020 at 6:00am
                  </p>
                </div>
              </div>
              <div className="view-info flex  flex-wrap gap-2">
              ...
              <div className="social-icons hidden md:flex items-center gap-2  ">
                {/* FB  */}
                <svg
                ...
                >
                  <path
                    d="M17.3263 0.903809H20.6998L13.3297 9.3273L22 20.7898H15.2112L9.89404 13.8378L3.80995 20.7898H0.434432L8.31744 11.7799L0 0.903809H6.96111L11.7674 7.25814L17.3263 0.903809ZM16.1423 18.7706H18.0116L5.9454 2.81694H3.93946L16.1423 18.7706Z"
                    fill="black"
                  />
                </svg>
                ...
                >
                  ...
                  />
                  <path
                    d="M18.8022 14.3944C20.3498 14.3944 21.6044 13.1398 21.6044 11.5922C21.6044 10.0446 20.3498 8.79004 18.8022 8.79004C17.2546 8.79004 16 10.0446 16 11.5922C16 13.1398 17.2546 14.3944 18.8022 14.3944Z"
                    fill="url(#paint0_radial_316_4855)"
                  />
                  <path
                    d="M5.19672 14.3944C6.74432 14.3944 7.99891 13.1398 7.99891 11.5922C7.99891 10.0446 6.74432 8.79004 5.19672 8.79004C3.64911 8.79004 2.39453 10.0446 2.39453 11.5922C2.39453 13.1398 3.64911 14.3944 5.19672 14.3944Z"
                    fill="url(#paint1_radial_316_4855)"
                  />
                  <path
                    d="M12.0055 19.9998C16.4237 19.9998 20.0052 17.3135 20.0052 13.9998C20.0052 10.686 16.4237 7.99976 12.0055 7.99976C7.58744 7.99976 4.00586 10.686 4.00586 13.9998C4.00586 17.3135 7.58744 19.9998 12.0055 19.9998Z"
                    fill="url(#paint2_radial_316_4855)"
                  />
                  <path
                    d="M9.64187 13.4165C9.59499 14.4327 8.91999 14.8021 8.1353 14.8021C7.35062 14.8021 6.75062 14.2818 6.79749 13.2655C6.84437 12.2493 7.51937 11.5762 8.30405 11.5762C9.08874 11.5762 9.68874 12.4002 9.64187 13.4165Z"
                    fill="#842123"
                  />
                  <path
                    d="M17.2161 13.2646C17.263 14.2808 16.6639 14.8011 15.8783 14.8011C15.0927 14.8011 14.4177 14.4327 14.3717 13.4155C14.3248 12.3993 14.9239 11.5752 15.7095 11.5752C16.4952 11.5752 17.1702 12.2474 17.2161 13.2646Z"
                    fill="#842123"
                  />
                  <path
                    d="M14.3716 13.5047C14.4156 14.4562 15.0466 14.8012 15.7816 14.8012C16.5166 14.8012 17.0772 14.2847 17.0331 13.3331C16.9891 12.3815 16.3581 11.759 15.6231 11.759C14.8881 11.759 14.3275 12.5531 14.3716 13.5047Z"
                    fill="url(#paint3_radial_316_4855)"
                  />
                  <path
                    d="M9.64251 13.5047C9.59844 14.4562 8.96751 14.8012 8.23251 14.8012C7.49751 14.8012 6.93688 14.2847 6.98094 13.3331C7.02501 12.3815 7.65594 11.759 8.39094 11.759C9.12595 11.759 9.68657 12.5531 9.64251 13.5047Z"
                    fill="url(#paint4_radial_316_4855)"
                  />
                  <path
                    d="M12.0071 15.48C11.0152 15.48 10.0646 15.5278 9.18519 15.615C9.03519 15.63 8.93957 15.7828 8.99769 15.9197C9.48988 17.0737 10.6514 17.8847 12.0071 17.8847C13.3627 17.8847 14.5233 17.0737 15.0164 15.9197C15.0746 15.7828 14.9799 15.63 14.8289 15.615C13.9496 15.5278 12.9989 15.48 12.0071 15.48Z"
                    fill="#BBCFDA"
                  />
                  <path
                    d="M12.0056 15.7002C11.0165 15.7002 10.0687 15.7489 9.19217 15.838C9.04217 15.853 8.94748 16.0086 9.0056 16.1474C9.49685 17.3202 10.6547 18.1433 12.0047 18.1433C13.3547 18.1433 14.5134 17.3193 15.0047 16.1474C15.0628 16.0086 14.9681 15.853 14.8181 15.838C13.9415 15.7489 12.9937 15.7002 12.0047 15.7002H12.0056Z"
                    fill="white"
                  />
                  <path
                    d="M12.0072 15.5859C11.0341 15.5859 10.1013 15.6338 9.23784 15.7209C9.09065 15.7359 8.9969 15.8888 9.05409 16.0256C9.5369 17.1797 10.6769 17.9906 12.0072 17.9906C13.3375 17.9906 14.4766 17.1797 14.9603 16.0256C15.0175 15.8888 14.9238 15.7359 14.7766 15.7209C13.9141 15.6338 12.9813 15.5859 12.0072 15.5859Z"
                    fill="url(#paint5_radial_316_4855)"
                  />
                  <path
                    d="M16.388 7.18414C17.4846 7.18414 18.3736 6.29515 18.3736 5.19852C18.3736 4.10189 17.4846 3.21289 16.388 3.21289C15.2913 3.21289 14.4023 4.10189 14.4023 5.19852C14.4023 6.29515 15.2913 7.18414 16.388 7.18414Z"
                    fill="url(#paint6_radial_316_4855)"
                  />
                  <path
                    d="M11.9791 8.25274C11.741 8.25274 11.5488 8.15337 11.5488 7.99962C11.5488 6.22024 12.9963 4.77368 14.7748 4.77368C15.0129 4.77368 15.2051 4.96681 15.2051 5.20399C15.2051 5.44118 15.012 5.63431 14.7748 5.63431C13.4707 5.63431 12.4095 6.69556 12.4095 7.99962C12.4095 8.15337 12.2163 8.25274 11.9791 8.25274Z"
                    fill="url(#paint7_radial_316_4855)"
                  />
                  <path
                    d="M9.11852 13.9754C9.11852 14.3438 8.72664 14.5088 8.24383 14.5088C7.76102 14.5088 7.36914 14.3438 7.36914 13.9754C7.36914 13.607 7.76102 13.3088 8.24383 13.3088C8.72664 13.3088 9.11852 13.607 9.11852 13.9754Z"
                    fill="#FF6101"
                  />
                  <path
                    d="M16.6439 13.9754C16.6439 14.3438 16.252 14.5088 15.7692 14.5088C15.2864 14.5088 14.8945 14.3438 14.8945 13.9754C14.8945 13.607 15.2864 13.3088 15.7692 13.3088C16.252 13.3088 16.6439 13.607 16.6439 13.9754Z"
                    fill="#FF6101"
                  />
                  <path
                    d="M8.84836 12.9759C9.02026 12.9759 9.15961 12.8239 9.15961 12.6365C9.15961 12.4491 9.02026 12.2971 8.84836 12.2971C8.67646 12.2971 8.53711 12.4491 8.53711 12.6365C8.53711 12.8239 8.67646 12.9759 8.84836 12.9759Z"
                    fill="#FFC49C"
                  />
                  <path
                    d="M16.2468 12.9759C16.4187 12.9759 16.558 12.8239 16.558 12.6365C16.558 12.4491 16.4187 12.2971 16.2468 12.2971C16.0749 12.2971 15.9355 12.4491 15.9355 12.6365C15.9355 12.8239 16.0749 12.9759 16.2468 12.9759Z"
                    fill="#FFC49C"
                  />
                  <defs>
                    <radialGradient
                      id="paint0_radial_316_4855"
                      cx="0"
                      cy="0"
                      r="1"
            ...
            <p className="mt-3 text-lightBlack desc text-[12px] md:text-[14px] dark:text-[rgba(255,255,255,0.8)]">
              Gold mining has a long history of environmental degradation,
            ...
            <h6 className="text-blackColor title text-[15px] mt-4 dark:text-white">
              Innovation and Mitigation Efforts:
            </h6>
            <p className="mt-3 text-lightBlack text-[12px] desc md:text-[14px] dark:text-[rgba(255,255,255,0.8)]">
              Both Bitcoin and gold mining industries are exploring innovations
              and mitigation strategies to reduce their environmental
              footprints. From the adoption of renewable energy sources in
              Bitcoin mining operations to the development of more sustainable
              mining practices in the gold industry, efforts are underway to
            ...
            {/* POST REACTION  */}
            <h2 className="text-blackColor font-[500] text-[20px] mt-8">
              Post Reactions
            </h2>

            <div className="reaction-buttons flex gap-5 mt-4 items-center">
              <button className="relative ">
                <div className="absolute rounded-full text-[10px] w-[20px] h-[20px] flex justify-center items-center bg-blue text-white top:top-[-4px] md:top-[-5px] right-0">
                  56
                </div>
                <svg
                ...
                >
                  ...
                  />
                  <path
                    d="M41.2738 39.1385L41.0652 21.6179C41.0485 20.2632 42.1498 19.148 43.5181 19.1315L50.0592 19.0571C51.4275 19.0406 52.5538 20.131 52.5705 21.4857L52.7791 39.0064C52.7958 40.3611 51.6945 41.4763 50.3262 41.4928L43.7851 41.5671C42.4084 41.5837 41.2904 40.4933 41.2738 39.1385ZM44.9531 22.7826C44.9615 23.8069 45.8125 24.633 46.847 24.6165C47.8816 24.6082 48.7159 23.7656 48.6993 22.7413C48.6909 21.717 47.8399 20.891 46.8053 20.9075C45.7708 20.9157 44.9448 21.7583 44.9531 22.7826Z"
                    fill="white"
                  />
                </svg>
              ...
              <button className="relative ">
                ...
                >
                  <path
                    d="M69.1739 34.9999C69.1739 53.8736 53.8737 69.1737 35 69.1737C16.1263 69.1737 0.826056 53.8736 0.826056 34.9999C0.826056 16.1262 16.1263 0.826056 35 0.826056C53.8737 0.826056 69.1739 16.1262 69.1739 34.9999Z"
                    fill="#FEDF06"
                    stroke="#333333"
              ...
              <button className="relative ">
                ...
                >
                  ...
                  />
                  <path
                    d="M28.2746 29.6709C29.0255 27.3497 28.0994 24.9789 26.2055 24.3841C24.3116 23.7894 22.1757 25.1854 21.4248 27.5066C20.6739 29.8278 21.6 32.1986 23.4939 32.7934C25.3879 33.3881 27.5321 31.9921 28.2746 29.6709Z"
                    fill="#3C3C3B"
                  />
                  <path
              ...
              <button className="relative ">
                ...
                >
                  <path
                    d="M69.1739 35C69.1739 53.8737 53.8738 69.1739 35 69.1739C16.1263 69.1739 0.826056 53.8737 0.826056 35C0.826056 16.1262 16.1263 0.826056 35 0.826056C53.8738 0.826056 69.1739 16.1262 69.1739 35Z"
                    fill="url(#paint0_linear_206_7985)"
                    stroke="#333333"
                    stroke-width="1.65211"
                  />
                  <path
              ...
              <button className="relative ">
                ...
                >
                  ...
                  />
                  <path
                    d="M16.0605 46.3418C20.2238 51.6781 27.1404 55.1806 34.9998 55.1806C42.8591 55.1806 49.784 51.6781 53.939 46.3418C53.939 46.3418 49.4002 39.2129 34.9998 39.2129C20.5993 39.2129 16.0605 46.3418 16.0605 46.3418Z"
                    fill="#D53025"
                  />
                  <path
            ...
            >
              ...
              <button
                className="border-blue border-[1px] text-blue rounded-md mt-3 px-3 py-1"
            ...
            <div className="block md:hidden my-5">
              <div className="flex justify-between border-2 border-[#DDDDD] p-3 rounded-md">
                <input
                  className="outline-none dark:bg-transparent"
                  type="text"
                  placeholder="Add Comment"
                />
                <button className="bg-blue px-3 py-1 rounded-md">Send</button>
              </div>
            </div>

            {/* FORM */}
            <div className="form mt-8 hidden md:block">
              <div className="inputFields gap-5 flex items-center">
                <input
                  className="flex-1 outline-none border-[#dddddd] text-lightBlack border-[1px] py-3 px-4 rounded-[8px] dark:bg-transparent"
                  type="text"
                  placeholder="Name"
                />
                <input
              ...
              <div className="textarea relative mt-3 border-[#dddddd] text-lightBlack border-[1px] py-3 px-4 rounded-[8px]">
                <textarea
                  className="w-full h-full outline-none dark:bg-transparent"
                  name=""
                  id=""
                  placeholder="Add Comment"
                ></textarea>
                <button className="bg-blue text-white text-right px-3 py-1 block rounded-[8px] ml-auto">
                  Post
                </button>
              </div>
            </div>
          ...
          <div className="w-[100%] md:w-[25%] ">
            ...
            <div className="hidden md:block px-5 py-3 border-2 border-[#DDDDDD] rounded-md">
              ...
              <div>
                <p className="title md:text-[18px] lg:text-[24px] xl:text-[32px] text-[#333333] my-3">
                  $0.00000035
                </p>
              </div>
              <div className="flex justify-between">
                <div>
                  <p className="md:text-[8px] lg:text-[12px] xl:text-[14px] text-[#AAAAAA]">
                    24h Volume
                  </p>
                  <p className="md:text-[8px] lg:text-[14px] xl:text-[16px] text-[#333333]">
                    $90,794,718
                  </p>
                </div>
                <div>
              ...
              <div className="flex items-center gap-5">
                <div className="flex items-baseline gap-2">
                  ...
                  >
                    <path
                      d="M6.625 0.25L3.5 3.375L0.375 0.25L6.625 0.25Z"
                      fill="#E04957"
                    />
                  </svg>
                  <p className="md:text-[8px] lg:text-[12px] xl:text-[14px] text-[#AAAAAA]">
            ...
            <div className="post-card mt-3">
              ...
              <h4 className="mt-4 text-blackColor font-[500] text-[14px] dark:text-white">
                From Shiba Inu to BabyDoge, Top 5 Altcoins Under $0.0001 to
                Watch
              </h4>
              <p className="mt-1 text-lightBlack text-[12px] font-semibold dark:text-[rgba(255,255,255,0.8)]">
                Aug 23, 2023
              </p>
            </div>
