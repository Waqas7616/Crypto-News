                ...
                <div className="flex justify-between items-center w-[60%] my-5">
                    ...
                    {tabs === 2 &&
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" value={featured} onChange={() => setFeatured(!featured)} class="sr-only peer" />
                    ...
                    <div className={tabs === 2 ? "content1 block" : "content1 hidden"}><div class="relative overflow-x-auto mt-3">
                        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                {!featured ?
                                    coinData.map((coin) => (
                                        <tr key={coin.id} class={coin.status === 'featured' ? "bg-[#2196F34D] border-b dark:bg-gray-800 dark:border-gray-700" : "bg-white border-b dark:bg-gray-800 dark:border-gray-700"}>
                                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                <div className="flex items-center gap-3">
                                                    <p>{coin.id}</p>
                                                    <Image src={coin.image} alt='coin' />
