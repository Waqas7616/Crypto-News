...
<p className="text-[16px] text-[#555555]">Use a minimum of 10 characters, including letters, lowercase letters, and numbers.</p>
          ...
          <div className="text-center mt-5 md:mt-12">
            ...
            By creating an account, you agree with our 
              ...
              <button className="text-[#16c782] title">Terms and Conditions</button>
              and
              <button className="text-[#16c782] title">Privacy Statement.</button>
            </p>
          </div>
        </div>
      </div>
