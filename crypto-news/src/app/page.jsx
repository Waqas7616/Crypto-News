    ...
    <>
      ...
      <div className="main w-11/12 m-auto mt-5">
        ...
        <div className="searchSection flex items-center justify-between">
          <h3 className="flex items-center gap-[3px] text-lightBlack">Sponsored: <span><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
