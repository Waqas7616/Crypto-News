  ...
  return (
    <html lang="en" className={`${isNightMode ? 'dark' : 'light'} `}>
      ...
      <body className="dark:bg-[#212121]">
        ...
        <div className="searchSection flex items-center justify-between mt-12 w-11/12 m-auto">
          <h3 className="flex items-center gap-1 text-lightBlack dark:text-white font-semibold">Sponsored: <span className="font-normal flex items-center"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
